...
/**
 * Attendants can only update your own informations.
 * Administrators can update any attendant
 */

const HandleUpdateAttendantsMiddleware = (request: Request, response: Response, next: NextFunction) => {
...
export default HandleUpdateAttendantsMiddleware;