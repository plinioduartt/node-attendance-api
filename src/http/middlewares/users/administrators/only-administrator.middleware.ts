...
const OnlyAdministratorMiddleware = (request: Request, response: Response, next: NextFunction) => {
    ...
    try {
        ...
        if (tokenPayload?.data.roleId !== roles.ADMINISTRATOR) {
...
export default OnlyAdministratorMiddleware;